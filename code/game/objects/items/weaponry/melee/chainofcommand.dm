...
/obj/item/melee/chainofcommand/darkpack/litany
	name = "chain of litany"
	desc = "A tool used by great gaian garou to remind stupid idiot cubs of the Litany. Can be used to hasten allies with right-click."
	icon = 'icons/obj/weapons/whip.dmi'
	icon_state = "chain"
	inhand_icon_state = "chain"
	worn_icon_state = "whip"
...
/obj/item/melee/chainofcommand/darkpack/litany/afterattack(atom/target, mob/user, list/modifiers, list/attack_modifiers)
	var/list/litanies = list("Garou Shall Not Mate With Garou",
